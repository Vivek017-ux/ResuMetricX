    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            <div className="navbar-start">
                ...
                <Link to={"/"} className="btn btn-ghost text-xl">ResuMaticX</Link>
            </div>
            ...
            <div className="navbar-end">
                <label className="swap swap-rotate btn btn-circle btn-ghost">
                    ...
                    <svg className="swap-on h-7 w-7 fill-current text-indigo-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
